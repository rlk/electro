...
add_tile("yorda10-10",  0, 0, global_x + dx * 3, global_y,          w, h)
add_tile("yorda11-10",  0, 0, global_x + dx * 3, global_y + dy,     w, h)
add_tile("yorda12-10",  0, 0, global_x + dx * 3, global_y + dy * 2, w, h)
add_tile("yorda13-10",  0, 0, global_x + dx * 4, global_y,          w, h)
add_tile("yorda14-10",  0, 0, global_x + dx * 4, global_y + dy,     w, h)
add_tile("yorda15-10",  0, 0, global_x + dx * 4, global_y + dy * 2, w, h)
