...
static void draw_galaxy_arrays(int i)
{
...
void draw_galaxy(int j, int i, const float M[16],
                 const float I[16],
...
void clone_galaxy(int i)
{
    G(i)->count++;
}

void delete_galaxy(int i)
{
    if (--G(i)->count == 0)
    {
        free_galaxy_gl(i);
