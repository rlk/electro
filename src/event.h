...
#define EVENT_SET_BRUSH_FRAG_PARAM 40
#define EVENT_SET_BRUSH_VERT_PARAM 41
#define EVENT_SET_BRUSH_LINE_WIDTH 42

#define EVENT_SET_GALAXY_MAGNITUDE 43
#define EVENT_SET_CAMERA_OFFSET    44
#define EVENT_SET_CAMERA_STEREO    45
#define EVENT_SET_CAMERA_RANGE     46
#define EVENT_SET_SPRITE_RANGE     47
#define EVENT_SET_SPRITE_BRUSH     48
#define EVENT_SET_STRING_FILL      49
#define EVENT_SET_STRING_LINE      50
#define EVENT_SET_STRING_TEXT      51
#define EVENT_SET_LIGHT_COLOR      52
#define EVENT_SET_BACKGROUND       53
#define EVENT_SET_FONT             54

#define EVENT_ADD_TILE             55
#define EVENT_SET_TILE_FLAGS       56
#define EVENT_SET_TILE_POSITION    57
#define EVENT_SET_TILE_VIEWPORT    58
#define EVENT_SET_TILE_LINE_SCREEN 59
#define EVENT_SET_TILE_VIEW_MIRROR 60
#define EVENT_SET_TILE_VIEW_OFFSET 61
