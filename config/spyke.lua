linescreen_file = "/disk2/varrier/electro/spyke-linescreen.lua"
...
-- This is a reasonable default configuration for Spyke
-- The REAL config should be loaded from the file
--linescreen = { 270.807188, -7.654, 0.0107, 0.00059, 0.777777 }
